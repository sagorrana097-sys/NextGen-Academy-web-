...
function repairPdfMixedStreamBengali(text) {
  ...
  const PHRASE_MAP = [
    ...
    [/Kিছু/g, 'কিছু'],
    [/আg/g, 'আম'],
    // Profit, Loss, and Commercial Math Sutonny mappings
    [/স্লতিতে/g, 'ক্ষতিতে'],
    [/স্লতি/g, 'ক্ষতি'],
    [/ক্রয়ম্j্য/g, 'ক্রয়মূল্য'],
    [/ক্রয়ম্j্য/g, 'ক্রয়মূল্য'],
    [/eিক্রয়ম্jে্যর/g, 'বিক্রয়মূল্যের'],
    [/eিক্রqম্jে্যর/g, 'বিক্রয়মূল্যের'],
    [/বিক্রয়ম্jে্যর/g, 'বিক্রয়মূল্যের'],
    [/বিক্রয়ম্jে্যর/g, 'বিক্রয়মূল্যের'],
    [/eিক্রয়ম্j্য/g, 'বিক্রয়মূল্য'],
    [/eিক্রqম্j্য/g, 'বিক্রয়মূল্য'],
    [/eিক্রq/g, 'বিক্রয়'],
    [/eিক্রয়/g, 'বিক্রয়'],
    [/eিক্রয়/g, 'বিক্রয়'],
    [/eিক্রি/g, 'বিক্রি'],
